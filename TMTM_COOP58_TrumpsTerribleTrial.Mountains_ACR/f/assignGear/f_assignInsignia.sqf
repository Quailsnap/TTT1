...
private _side = toLower (faction _unit);
...
if (_side == "blu_ctrg_f") then {_side = "blu_f"};
...
switch (_side) do
{
	case "blu_f" : {
		if (_insignia_style_NATO == "Tanoa") then {
			...
			_groupBadges = [
				["GrpBLU_A","NATO_ASL_Badge"],
				["GrpBLU_B","NATO_BSL_Badge"],
				["GrpBLU_C","NATO_CSL_Badge"],
				["GrpBLU_D","NATO_DC_Badge"],
				["GrpBLU_CO","NATO_CO_Badge"],
				["GrpBLU_O","NATO_JSL_Badge"]
			];
		};
	};
	case "blu_t_f": {
		...
		switch (_insignia_style_CSAT) do
		{
			...
			case "Altis" : {
				_groupBadges = [
					...
					["GrpCSAT_DSL","CSAT_DC_Badge"],
					["GrpCSAT_JSL","CSAT_JSL_Badge"]
				];
			};
			case "Urban" : {
				_groupBadges = [
