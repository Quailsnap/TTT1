...
f_showVehicle_Nametags = true;  // Show type of vehicle under driver's name
f_showCursorOnly_Nametags = true; // Show only units under cursor target (disable 360° view)

// Other values
f_distCursor_Nametags = 18;		// Distance to display name tag for unit under cursor
f_distAll_Nametags = 18;		// Distance to display name tags for all units around
...
f_height_standing_Nametags = 1.3; // Height above standing infantry unit
f_height_crouch_Nametags = 0.8; // Height above crouching infantry unit
f_height_prone_Nametags = 0.2;  // Height above prone infantry unit
...
f_color_Nametags =  [0.71,0.94,0.43,0.85]; // The color for infantry and units in vehicle cargo (in [red,green, blue, opacity])
f_color2_Nametags = [0.95,0.85,0.05,0.85]; // The color for units in driver, gunner and other vehicle positions positions
f_groupColorR_Nametags = [0.95,0.40,0.40,0.85]; // The color for units of the same group, team red
f_groupColorG_Nametags = [0.40,0.95,0.40,0.85]; // The color for units of the same group, team green
f_groupColorB_Nametags = [0.40,0.40,0.95,0.85]; // The color for units of the same group, team blue
f_groupColorY_Nametags = [0.95,0.95,0.40,0.85]; // The color for units of the same group, team yellow
f_groupColor_Nametags  = [1   ,1   ,1   ,0.85]; // The color for units of the same group
