...
//-----------------------------------------------------------------------------------------------
	...
	{		
				...
				_setShowUnit 		= [1,1,1,1];
				_setGroupType 		= 1;
				_setMarkerText		= ["if(format[""%1"",_group] == ""<NULL-group>"") then {format[""<--- %1"",typeof _unit]} else {format[""%1"",groupID (group leader _group)]}"];
				_setMarkerDel 		= 1;
				_setMarkerRefresh 	= [0.25,0.25];
				_setSizeWpLine 		= [1,5];
				...
				_setMarkerClass		= [
										...
										[
											["CAR","mil_dot",[0.8,1.2],1],
											["TRUCK","mil_dot",[1,1.5],1]
										],
										[
											["TANK","mil_box",[0.8,1.3],1],
											["APC","mil_box",[0.6,1],1]
										],
										[
										...
										[
											["AIR","mil_triangle",[1.2,1.2],1],
											["HELICOPTER","mil_triangle",[1.2,1.2],1],
											["PLANE","mil_triangle",[1.4,2],1],
