...
//-------------------------------------------------------------------------------------------------
// US Marines Woodland (CUP)
  case 6:
  {
    _Unit_Pool_S = ["CUP_B_USMC_Crew","CUP_B_USMC_Pilot","CUP_B_USMC_Soldier_SL","CUP_B_USMC_Soldier_AR","CUP_B_USMC_Soldier_AR","CUP_B_USMC_Engineer","CUP_B_FR_Soldier_GL","CUP_B_USMC_Medic","CUP_B_USMC_Soldier_MG","CUP_B_FR_Soldier_Marksman","CUP_B_FR_Commander","CUP_B_USMC_Soldier_AT","CUP_B_USMC_Soldier","CUP_B_USMC_Soldier","CUP_B_USMC_Soldier","CUP_B_USMC_Soldier","CUP_B_USMC_Soldier"];
    _Unit_Pool_V = ["CUP_B_MTVR_USMC","CUP_B_MTVR_USMC","CUP_B_MTVR_USMC","CUP_B_MTVR_Refuel_USMC"];
    _Unit_Pool_T = ["CUP_B_M113_USA","CUP_B_M113_USA","CUP_B_M113_USA","CUP_B_LAV25M240_USMC"];
    _Unit_Pool_A = ["CUP_I_UH1H_TK_GUE"];
  };
//-------------------------------------------------------------------------------------------------
...
//-------------------------------------------------------------------------------------------------
  ...
  case 8:
  {
    _Unit_Pool_S = ["rhs_g_engineer_F","rhs_g_medic_F","rhs_g_Soldier_SL_F","rhs_g_Soldier_F","rhs_g_Soldier_AR_F","rhs_g_Soldier_lite_F","rhs_g_Soldier_lite_F","rhs_g_Soldier_lite_F","rhs_g_Soldier_lite_F","rhs_g_Soldier_lite_F","rhs_g_Soldier_lite_F","rhs_g_Soldier_lite_F","rhs_g_Soldier_lite_F","rhs_g_Soldier_lite_F","rhs_g_Soldier_lite_F","rhs_g_Soldier_lite_F","rhs_g_Soldier_LAT_F","rhs_g_Soldier_M_F","rhs_g_Soldier_exp_F"];
    _Unit_Pool_V = ["rhs_ural_open_chdkz","RHS_UAZ_chdkz"];
    _Unit_Pool_T = ["rhs_btr70_chdkz"];
    _Unit_Pool_A = ["RHS_Mi8amt_chdkz"];
  };
//-------------------------------------------------------------------------------------------------
    // Afghani Militia (Leights OPFOR Pack. RHS)
  case 9:
  {
    _Unit_Pool_S = ["LOP_AM_Infantry_Engineer","LOP_AM_Infantry_SL",
					"LOP_AM_Infantry_Corpsman","LOP_ISTS_Infantry_Corpsman","LOP_AM_Infantry_AR",
					"LOP_AM_Infantry_AR","LOP_AM_Infantry_GL","LOP_ISTS_Infantry_Engineer",
					"LOP_ISTS_Infantry_Marksman","LOP_AM_Infantry_AT","LOP_ISTS_Infantry_Rifleman",
					"LOP_AM_Infantry_Rifleman","LOP_AM_Infantry_Rifleman"];
    _Unit_Pool_V = ["LOP_AM_Landrover","LOP_ISTS_Landrover","LOP_AM_Landrover_M2","LOP_UA_UAZ",
					"LOP_UA_Ural_open","C_Van_01_box_F","RDS_Gaz24_Civ_01","RDS_Gaz24_Civ_02",
					"RDS_Gaz24_Civ_03","LOP_UA_Ural_open"];
    _Unit_Pool_T = ["LOP_AM_M113_W","LOP_AM_M113_W","LOP_AM_M113_W","LOP_AM_M113_W","LOP_AM_BTR_60",
					"LOP_AM_BTR_60","LOP_ISTS_BMP1"];
    _Unit_Pool_A = ["RHS_Mi8amt_chdkz"];
  };
//-------------------------------------------------------------------------------------------------
    // Takistani Locals (Community Upgrade Project)
  case 10:
  {
    _Unit_Pool_S = ["CUP_I_TK_GUE_Soldier","CUP_I_TK_GUE_Soldier","CUP_I_TK_GUE_Soldier_M16A2","CUP_I_TK_GUE_Soldier_AR","CUP_I_TK_GUE_Soldier_AR","CUP_I_TK_GUE_Soldier_GL","CUP_I_TK_GUE_Soldier","CUP_I_TK_GUE_Soldier","CUP_I_TK_GUE_Guerilla_Medic","CUP_I_TK_GUE_Guerilla_Medic","CUP_I_TK_GUE_Soldier","CUP_I_TK_GUE_Soldier","CUP_I_TK_GUE_Soldier","CUP_I_TK_GUE_Soldier"];
    _Unit_Pool_V = ["CUP_I_V3S_Covered_TKG","CUP_I_V3S_Open_TKG","CUP_I_Datsun_PK_TK_Random",		
					"CUP_I_Datsun_PK_TK","CUP_C_LR_Transport_CTK","CUP_C_Datsun_4seat"];
    _Unit_Pool_T = ["CUP_I_T34_TK_GUE"];
    _Unit_Pool_A = ["CUP_C_AN2_AIRTAK_TK_CIV","CUP_I_UH1H_TK_GUE"];
  };
